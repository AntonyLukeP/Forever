                ...
                (
                  ...
                  className='border-b hover:border-gray-50 cursor-pointer' >
                    ...
                    <td className='py-2 px-2 sm:py-4 sm:px-4' >
                      ...
                      <td className='py-2 px-2 sm:py-4 sm:px-4' >
                        <span className={`${order.isPaid ?"bg-green-100 text-green-700":"bg-red-100 text-red-700" } px-2 py-1 rounded-full text-sm font-medium `} >{`${order.isPaid ? "Paid":"Not Paid"}`}</span>
                      </td>
                  </tr>
                ))
              ):

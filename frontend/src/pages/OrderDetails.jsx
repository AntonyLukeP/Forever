            ...
            <div className='border rounded-lg p-4 sm:p-6' > 
                <div className='flex flex-col sm:flex-row justify-between mb-8' >
                    <div>
                     ...
                     <div className='flex flex-col items-start sm:items-end mt-4 sm:mt-8' >
                        <span className={`${orderDetails.isPaid?"bg-green-100 text-green-700":"bg-yellow-100 text-yellow-700"}
                        ...
                        px-3 py-1 rounded-full text-sm font-medium mb-2
                        `} >{orderDetails.isPaid?"Delivered":"Pending Delivery"}</span>
                     </div>
                </div>
                            ...
                            (
                                    <tr className='border-b' key={item.productId} >
                                        <td className='py-2 px-4 flex items-center' >
                                            ...
                                            />
                                            <Link
                                            to={`/product/${item.productId}`} className='text-blue-500 hover:underline'
                                            >{item.name}</Link>
                                        </td>
                ...
                <Link to="/my-orders" className='hover:underline text-blue-500' >Back to My orders</Link>
            </div>
        )
